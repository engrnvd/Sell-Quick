    ...
    function Plugin($container, options) {
        ...
        function _setEvents() {
            if(self.options.buttons) {
                $prev.on('click dblclick',function() {
                    self.move(--slideIndex);
                    return false;
                });

                $next.on('click dblclick',function() {
                    self.move(++slideIndex);
                    return false;
                });
            }
...
$(document).ready(function()
{
    ...
    $(".buttons.next").on('click dblclick', function () {
        //console.log("we are here");
        $(".buttons.next").addClass("disable");
        $(".buttons.prev").removeClass("disable");
    });
    $(".buttons.prev").on('click dblclick', function () {
        //console.log("we are here");
        $(".buttons.prev").addClass("disable");
        $(".buttons.next").removeClass("disable");
    });
